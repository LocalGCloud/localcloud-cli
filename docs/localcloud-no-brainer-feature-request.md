...
| Discover configuration | Developer gets all env vars/endpoints for their project and enabled services. | `/_localcloud/env` supports shell/Terraform formats. | Needs stronger project/region/profile awareness and language/framework snippets. | P1 |
