CREATE TABLE Transactions (
  ...
  CONSTRAINT PK_Transactions PRIMARY KEY (ShardId, CustomerId, YearMonth, RevTimestamp, TransactionId),
  CONSTRAINT FK_Transactions_Customers FOREIGN KEY (ShardId, CustomerId) REFERENCES Customers (ShardId, CustomerId),
  CONSTRAINT UQ_Transactions_Ref UNIQUE NONNULL (TransactionRef),
